...
export const menuItems = [
  { name: "Accueil", path: "/", exact: true, icon: "home", inverted: true },
  { name: "Documents utiles", path: "/about/", exact: true, icon: "info circle" },
  { name: "Events", path: "/blog/", exact: false, icon: "newspaper" },
];
